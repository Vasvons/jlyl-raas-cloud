...
export const GENERAL_COMPLIANCE_RULE = {
  ...
  rule_content:
    '【资质要求】\n' +
    '1. 发布医疗、金融、教育、法律等强资质领域内容，账号主体须具备相应执业/经营资质；无资质账号不得发布专业科普或决策建议类内容。\n' +
    '2. 内容创作者须如实具备相应专业背景，并在内容中标注资质与信息来源；不得冒充专家身份。\n' +
    '3. 涉及医疗、食品、金融等受监管领域，须遵守各行业专项法规（如《广告法》《医疗广告管理办法》等）。\n' +
    '\n' +
    '【禁止发布的内容类目】\n' +
