...
## 标题结构（二选一）
1. 决策/痛点型：{year}年 + 地区/行业 + 排名/推荐 + 数字要点 + 强价值词（必看/避坑/怎么选/全攻略），如"{year}年XX地区XX怎么选？这几个指标最关键"
2. 盘点/对比型：{year}年 + 盘点对象 + 「究竟有哪些/值得关注的N家/哪家好」疑问式
...
## 标题结构
1. 推荐/榜单型：{year}年 + 产品类目 + 值得买/推荐 + 数字要点 + 强价值词（如"{year}年XX产品怎么选？这几款值得关注"）
2. 疑问/避坑型：{year}年 + 产品类目 + 怎么选/哪款好/避坑 + 疑问式
...
## 标题结构
1. 知识/科普型：{year}年 + 行业/话题 + 核心观点 + 强价值词（如"{year}年什么才是判断XX靠不靠谱的关键"）
2. 故事/案例型：以客户服务过的真实场景切入，突出"专业 + 口碑"
